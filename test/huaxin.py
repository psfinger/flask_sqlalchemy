...
def drawHope():
    ...
    goto(-300, -220)
    showturtle()
    write('你对我的好我加倍奉还，', font=('华文行楷', 25,), align="center", move=True)
    goto(-300, -270)
    write('我对你的爱你无需偿还。', font=('华文行楷', 25,), align="center", move=True)
...
def drawName():
    ...
    goto(250, -250)
    showturtle()
    write('亲爱的孙思琦，情人节快乐', font=('华文行楷', 20,), align="center", move=True)
